...
@php
    $classes = $active
        ? 'flex items-center gap-x-2 w-full ps-3 pe-4 py-2 border-l-4 border-lime-500 text-start text-base font-medium text-lime-800 bg-lime-100 focus:outline-none focus:text-lime-900 focus:bg-lime-200 focus:border-lime-800 transition duration-150 ease-in-out'
