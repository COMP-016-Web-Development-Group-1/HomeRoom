    ...
    <div class="py-4 min-h-screen">
        <div class="w-full px-2 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-6 min-h-[80vh]">
                ...
                <div class="w-full lg:w-1/3 flex flex-col h-auto lg:h-[calc(100vh-100px)] min-h-[400px] order-1">
                    <div class="bg-white rounded-xl shadow p-6 flex flex-col flex-1 justify-between h-full">
                        <div>
                        ...
                        <div class="flex flex-col gap-4 flex-1 justify-center">
                            <div class="bg-gray-50 rounded-lg p-4 flex flex-col items-center shadow-sm flex-1 justify-center">
                ...
                {{-- Main Content Column --}}
                <div class="w-full lg:w-2/3 flex flex-col gap-4 h-auto order-2">
                    ...
                    <div class="flex flex-col gap-4 flex-1 justify-between h-full">
                        <div class="bg-white rounded-xl shadow p-6 flex-1 flex flex-col mb-0">
                        ...
                        <div class="bg-white rounded-xl shadow p-6 flex-1 flex flex-col mt-0">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="overflow-x-auto w-full">
                                    <table class="min-w-full table-fixed border-separate" style="border-spacing: 0">
                                        <colgroup>
                                            <col style="width: 8%;">
                                            <col style="width: 17%;">
                                            <col style="width: 25%;"> <!-- This is now for Title -->
                                            <col style="width: 35%;">
                                            <col style="width: 15%;">
                                        </colgroup>
                                        <thead>
